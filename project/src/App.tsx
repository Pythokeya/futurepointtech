...
import DataAnalyticsCourse from './components/DataAnalyticsCourse';
  ...
  return (
    <Router>
      <Routes>
        ...
        />
        <Route path="/DataAnalyticsCourse" element={<DataAnalyticsCourse />} />
        <Route 
          path="/course/data-analytics" 
          element={<HTMLViewer path="/courses/data-analytics.html" />} 
        />
        <Route path="/courses/data-analytics" element={<CourseContent />} />
      </Routes>
    </Router>
  );
}
